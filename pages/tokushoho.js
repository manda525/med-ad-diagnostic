...
const rows = [
  ...
  {
    label: "販売価格",
    value: "個人プラン 月額500円（税込）／法人プラン 月額5,000円（税込）／薬剤師相談（単発） 1回1,980円（税込）",
  },
  {
    label: "商品代金以外の必要料金",
    value:
  ...
  { label: "お支払い方法", value: "クレジットカード決済（Stripe）" },
  {
    label: "お支払い時期",
    value:
      "サブスクリプション：お申し込み時に初回決済。以降、毎月同日に自動更新・自動決済されます。薬剤師相談（単発）：お申し込み時に1回のみ決済。自動更新はありません。",
  },
  {
    label: "役務の提供時期",
    value: "サブスクリプション：決済完了後、ただちにご利用いただけます。薬剤師相談（単発）：相談内容のメールを受領してから3営業日以内に、メールで文章による回答をお送りします。",
  },
  {
    label: "解約・返金について",
    value:
      "サブスクリプションはいつでも解約可能です（アプリ内「支払い・解約」より手続き）。解約後は、現在の請求期間の満了日までご利用いただけます。デジタルサービスの性質上、決済済み期間の日割り返金は行いません。薬剤師相談（単発）は、回答送付前であれば全額返金します。回答送付後の返金は行いません。",
  },
  {
    label: "動作環境",
